...
export const testBlock = {
    mainnet: [
        ...
        },
        {
            ...
            energyLimit: BigInt("30087914"),
            energyUsed: BigInt("2008910"),
            miner: "0x2A20380DcA5bC24D052acfbf79ba23e988ad0050",
            extraData: "0x706f6f6c696e2e636f6d21f7092f019bb92a76",
            baseFeePerEnergy: BigInt("40911884304"),
            transactions: [
    ...
    mainnet: [
        {
            ...
            energyPrice: BigInt("0x4a817c800"),
            energyLimit: BigInt("0x3d090"),
        ...
        },
        {
            ...
            energyLimit: BigInt("21000"),
            nonce: 2,
            data: '0x',
            value: BigInt("1100000000000000"),
            energyPrice: BigInt("70578812137"),
            networkId: BigInt(1),
            signature: {
    ...
    mainnet: [
        {
            ...
            cumulativeEnergyUsed: BigInt(0x1cca2e),
            from: "0x18C6045651826824FEBBD39d8560584078d1b247",
            energyUsed: BigInt(0x14bb7),
            energyPrice: BigInt(4100000000),
            logs: [
                {
            ...
            type: 0,
            contractAddress: null,
            cumulativeEnergyUsed: BigInt(0x15bfe7),
            from: "0x18C6045651826824FEBBD39d8560584078d1b247",
            energyUsed: BigInt(0x1b968),
            energyPrice: BigInt(1000000000),
            logs: [
                {
