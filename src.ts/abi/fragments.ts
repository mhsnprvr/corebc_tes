...
export interface JsonFragment {
    ...
    /**
     *  The energy limit to use when sending a transaction for this function.
     */
...
function consumeEnergy(tokens: TokenString): null | bigint {
...
export class ConstructorFragment extends Fragment {
    readonly payable!: boolean;
    readonly energy!: null | bigint;

    /**
     *  @private
     */
    constructor(guard: any, type: FragmentType, inputs: ReadonlyArray<ParamType>, payable: boolean, energy: null | bigint) {
        super(guard, type, inputs);
        Object.defineProperty(this, internal, { value: ConstructorFragmentInternal });
        defineProperties<ConstructorFragment>(this, { payable, energy });
    }
    ...
    format(format?: FormatType): string {
        ...
        if (this.energy != null) { result.push(`@${ this.energy.toString() }`); }
        return result.join(" ");
    }
    ...
    static from(obj: any): ConstructorFragment {
        ...
        return new ConstructorFragment(_guard, "constructor",
            obj.inputs ? obj.inputs.map(ParamType.from): [ ],
            !!obj.payable, (obj.energy != null) ? obj.energy: null);
    }
...
export class FunctionFragment extends NamedFragment {
     ...
     *  @private
     */
    constructor(guard: any, name: string, stateMutability: "payable" | "nonpayable" | "view" | "pure", inputs: ReadonlyArray<ParamType>, outputs: ReadonlyArray<ParamType>, energy: null | bigint) {
        super(guard, "function", name, inputs);
        Object.defineProperty(this, internal, { value: FunctionFragmentInternal });
        outputs = Object.freeze(outputs.slice());
        const constant = (stateMutability === "view" || stateMutability === "pure");
        const payable = (stateMutability === "payable");
        defineProperties<FunctionFragment>(this, { constant, energy, outputs, payable, stateMutability });
    }
    ...
    static from(obj: any): FunctionFragment {
        ...
        if (typeof(obj) === "string") {
            ...
            return new FunctionFragment(_guard, name, mutability, inputs, outputs, energy);
        }
        ...
        return new FunctionFragment(_guard, obj.name, stateMutability,
             ...
             (obj.energy != null) ? obj.energy: null);
    }
